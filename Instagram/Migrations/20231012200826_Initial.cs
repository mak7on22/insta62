        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Publications = table.Column<int>(type: "integer", nullable: true),
                    Subscribers = table.Column<int>(type: "integer", nullable: true),
                    Subscribes = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComentsCount = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: true),
                    DateOfAdd = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SubscribesAndSubscriptions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscribesAndSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscribesAndSubscriptions_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubscribesAndSubscriptions_AspNetUsers_SubscriberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscribesAndSubscriptions_AuthorId",
                table: "SubscribesAndSubscriptions",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscribesAndSubscriptions_SubscriberId",
                table: "SubscribesAndSubscriptions",
                column: "SubscriberId");
        }
